...
const totalContributions = GAMES_JSON.reduce((acc, contributions) => {
  return acc + contributions.backers;
}, 0);
...
gamesCard.innerHTML = GAMES_DATA.length;
...
function filterUnfundedOnly() {
  ...
  //console.log(gamesGoalNotMet.length);
...
const displayStr =
  unfundedGameCount === 0
    ? "We reached our goal of funding all games! Thank you for all your support!"
    : `We still need your help funding ${unfundedGameCount} games. Any little bit counts!`;
